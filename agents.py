...
ЗАПРЕЩЕНО: выдумывать цифры, скрывать неопределённость, давать одинаковый
вывод что и Bear — если вы согласны, значит один из вас не думает самостоятельно.

Максимум 4 сильных аргумента. Лучше 3 убедительных чем 6 слабых."""
...
ЗАПРЕЩЕНО: соглашаться с Bull без критики, давать тот же итоговый вывод что и он,
...
ШАГ 3: НАЙДИ ОДИНАКОВЫЕ ВЫВОДЫ
🚨 КРИТИЧНО: Если Bull и Bear пришли к одинаковому итогу — это ОШИБКА.
Напиши: "⚠️ ОДИНАКОВЫЕ ВЫВОДЫ — Bull и Bear оба написали [X].
Это значит один из них не думает самостоятельно. Synth должен это учесть."
...
БЫЧИЙ (примерно Y%): [триггеры + что вырастет, что упадёт]
МЕДВЕЖИЙ (примерно Z%): [триггеры + что вырастет, что упадёт]
ВАЖНО: Бычий = рисковые активы растут. Медвежий = рисковые активы падают.

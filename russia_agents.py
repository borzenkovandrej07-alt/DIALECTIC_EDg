...
Топ-3 инструмента с конкретными тикерами и расчётом доходности.
Формат: "[Тикер] — [доходность]% — [причина выбора]"
Пример: "LQDT — ~20.5% — фонд денежного рынка, ликвидность за 1 день, минимум риска"
Если данных нет по конкретному тикеру — используй диапазон по сектору.

💵 USD/RUB ПРОГНОЗ (3 сценария):
Базируйся на текущем курсе из данных ЦБ РФ.
Базовый (50%): [курс через 3 мес] — триггеры: [нефть + ставка ЦБ]
Медвежий (30%): [курс через 3 мес] — триггеры: [падение нефти / санкции]
Бычий (20%): [курс через 3 мес] — триггеры: [рост нефти / снижение ставки]
Хедж: юаневые облигации или форварды CNY/RUB

💸 РЕАЛЬНАЯ ДОХОДНОСТЬ (топ-3 инструмента после налогов):
Формат: "[Инструмент] — номинал X% → после налога ~Y% → реально Z% (минус инфляция)"
ОФЗ: купонный доход НЕ облагается налогом → особо выгодны
Вклады: налог 13% на доход выше ключевой ставки
